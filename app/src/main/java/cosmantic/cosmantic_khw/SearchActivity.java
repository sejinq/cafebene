...
public class SearchActivity extends Activity {
    ...
    private void settingList(Context context, String searchWord, LinearLayout list)
    {
        ...
        for (int i = 0; i < products.length; ++i) {
            ...
            setFont(layout);
            //제품 이미지
            ((ImageView) layout.findViewById(R.id.searchResultImage)).setImageBitmap(((MyApplication) context).getImage(product.getThumnail()));
            //제품 브랜드
            ((TextView) layout.findViewById(R.id.searchResultBrandName)).setText(product.getBrand());
            //제품명
            ((TextView) layout.findViewById(R.id.searchResultProductName)).setText(product.getProductName());
    ...
    private void settingHeart(String product_id)
    {
        ...
        {
            ((ImageView)findViewById(R.id.searchResultProduct_like)).setVisibility(View.VISIBLE);
            ((ImageView)findViewById(R.id.searchResultProduct_like)).setImageResource(R.drawable.love_inable);
        }
    }
    ...
    {
        FontApplyer.setFont(this, ((TextView)layout.findViewById(R.id.searchResultBrandName)), FontApplyer.Font.NotoSans, FontApplyer.Style.Medium);
        FontApplyer.setFont(this, ((TextView)layout.findViewById(R.id.searchResultProductName)), FontApplyer.Font.NotoSans, FontApplyer.Style.Regular);
    }
    @Override
